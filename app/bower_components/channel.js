...
bitcore.errors.Channel = function() {
  this.message = 'Internal Error on bitcore-channels Module ' + arguments[0] + '';
  this.stack = this.message + '\n' + (new Error()).stack;
};
bitcore.errors.Channel.prototype = Object.create(bitcore.errors.prototype);
bitcore.errors.Channel.prototype.name = "bitcore.errors.Channel";

module.exports = bitcore.errors;
...
},{"./lib/Consumer":1,"./lib/Provider":2,"./lib/errors":3}]},{},["bitcore-channel"]);
